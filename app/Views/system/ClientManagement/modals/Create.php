            ...
            <div class="tab-pane fade show active" id="client" role="tabpanel">
              ...
              <div class="row">
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="inputName" name="name" placeholder="First Name" value="<?= old('name') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputLastname">Last Name</label>
                  <input type="text" class="form-control" id="inputLastname" name="last_name" placeholder="Last Name" value="<?= old('last_name') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputIdentity">Identification</label>
                  <input type="number" class="form-control" id="inputIdentity" name="identification" placeholder="ID" value="<?= old('identification') ?>">
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="inputPhone" name="phone" placeholder="Phone" value="<?= old('phone') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputAddress">Address</label>
                  <input type="text" class="form-control" id="inputAddress" name="address" placeholder="Address" value="<?= old('address') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputTrust">Trust</label>
                  <input type="text" class="form-control" id="inputTrust" name="trust" placeholder="Trust" value="<?= old('trust') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputTrustEmail">Trust Email</label>
                  <input type="email" class="form-control" id="inputTrustEmail" name="email_del_trust" placeholder="Trust Email" value="<?= old('email_del_trust') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputTrustPhone">Trust Phone</label>
                  <input type="text" class="form-control" id="inputTrustPhone" name="telephone_del_trust" placeholder="Trust Phone" value="<?= old('telephone_del_trust') ?>">
                </div>
              </div>
            ...
            <div class="tab-pane fade" id="banking" role="tabpanel">
              ...
              <div class="row">
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="inputBank" name="bank" placeholder="Bank" value="<?= old('bank') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputSwift">SWIFT</label>
                  <input type="text" class="form-control" id="inputSwift" name="swift" placeholder="SWIFT" value="<?= old('swift') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputAba">ABA</label>
                  <input type="text" class="form-control" id="inputAba" name="aba" placeholder="ABA" value="<?= old('aba') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputIban">IBAN</label>
                  <input type="text" class="form-control" id="inputIban" name="iban" placeholder="IBAN" value="<?= old('iban') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputAccount">Account</label>
                  <input type="text" class="form-control" id="inputAccount" name="account" placeholder="Account" value="<?= old('account') ?>">
                </div>
              </div>
            ...
            <div class="tab-pane fade" id="financial" role="tabpanel">
              ...
              <div class="form-row">
                <div class="form-group col-md-3">
                  ...
                  <input type="text" class="form-control" id="inputPrincipal" name="principal" placeholder="E.g. 5,000,000.00" value="<?= old('principal') ?>">
                </div>
                <div class="form-group col-md-3">
                  <label for="inputRate">Interest Rate</label>
                  <input type="text" class="form-control" id="inputRate" name="rate" placeholder="E.g. 12.50" value="<?= old('rate') ?>">
                </div>
                <div class="form-group col-md-3">
                  <label for="inputCompounding">Periods</label>
                  <input type="number" class="form-control" id="inputCompounding" name="compoundingPeriods" placeholder="E.g. 12" value="<?= old('compoundingPeriods') ?>">
                </div>
                <div class="form-group col-md-3">
                  <label for="inputTime">Time (years)</label>
                  <input type="number" class="form-control" id="inputTime" name="time" placeholder="E.g. 5" value="<?= old('time') ?>">
                </div>
            ...
            <div class="tab-pane fade" id="agreement" role="tabpanel">
              ...
              <div class="form-row">
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="inputAgreement" name="agreement" placeholder="Agreement" value="<?= old('agreement') ?>">
                </div>
                <div class="form-group col-md-2">
                  <label for="inputNumber">Number</label>
                  <input type="number" class="form-control" id="inputNumber" name="number" placeholder="Number" value="<?= old('number') ?>">
                </div>
                <div class="form-group col-md-2">
                  <label for="inputLetter">Letter</label>
                  <input type="text" class="form-control" id="inputLetter" name="letter" placeholder="Letter" value="<?= old('letter') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputPolicy">Policy</label>
                  <input type="text" class="form-control" id="inputPolicy" name="policy" placeholder="Policy" value="<?= old('policy') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputDateFrom">From</label>
                  <input type="date" class="form-control" id="inputDateFrom" name="date_from" value="<?= old('date_from') ?>">
                </div>
                <div class="form-group col-md-4">
                ...
                <div class="form-group col-md-4">
                  ...
                  <input type="text" class="form-control" id="inputApprovedBy" name="approved_by" placeholder="Approved By" value="<?= old('approved_by') ?>">
                </div>
                <div class="form-group col-md-4">
                  <label for="inputApprovedDate">Approved Date</label>
                  <input type="date" class="form-control" id="inputApprovedDate" name="approved_date" value="<?= old('approved_date') ?>">
                </div>
              </div>
              <div class="d-flex justify-content-between">
                <button type="button" class="btn btn-secondary prev-tab">Previous</button>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  let input = document.querySelector('input.errors-insert, select.errors-insert, textarea.errors-insert');
  if (input) {
