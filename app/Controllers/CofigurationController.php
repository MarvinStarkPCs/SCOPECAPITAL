...
use App\Models\CofigurationModel;
use CodeIgniter\Controller;

class CofigurationController extends BaseController
{
    public function index()
    {
        $CofigurationModel = new CofigurationModel();
    
        // Obtener la configuración SMTP desde la base de datos
        $stmp_config_data = $CofigurationModel->where('config_key', 'smtp_config')->first();
    ...
    public function saveSMTPConfig()
    {
        ...
        try {
            $CofigurationModel = new CofigurationModel();
            $CofigurationModel->updateSMTPConfig($data);
